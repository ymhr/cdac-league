...
export default function Privacy() {
  return (
    <>
      ...
      <p>
        CDAC Agility League ("us", "we", or "our") operates the
        https://masleague.run website (hereinafter referred to as the
        "Service").
      </p>
      ...
      <p>
        ...
        have associated with that data. Our Privacy Policy for CDAC Agility
        League is created with the help of the{" "}
      ...
      <p>
        ...
        in our Terms and Conditions, accessible from https://masleague.run
      </p>
      ...
      <p>CDAC Agility League uses the collected data for various purposes:</p>
      <ul>
      ...
      <p>
        CDAC Agility League will take all steps reasonably necessary to ensure
      ...
      <p>
        CDAC Agility League may disclose your Personal Data in the good faith
        belief that such action is necessary to:
      </p>
      <ul>
        <li>To comply with a legal obligation</li>
        <li>
          To protect and defend the rights or property of CDAC Agility League
        </li>
        <li>
      ...
      <ul>
        <li>By email: jamesmartin442+masleague@gmail.com</li>
      </ul>
    </>
  );
}
