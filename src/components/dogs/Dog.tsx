...
import { Button, Form, Input, InputNumber, Icon, Select } from "antd";
...
function Dog({ dog, newDoc, form }: DogProps & FormComponentProps) {
  ...
  return (
    <>
      ...
      >
        {isOpen && <Close onClick={close} shape="circle" icon="close" />}
        <Name pose={isOpen ? "large" : "small"}>
          {isNew ? (
            ...
            <>
              {data.name}{" "}
              {!isOpen && (
                <Button style={{ float: "right" }} onClick={goToLogPoints}>
                  Log points
                </Button>
              )}
            </>
                ...
                <Form.Item label="Name">
                  {getFieldDecorator("name", {
                    rules: [
                      {
                        required: true,
                        message: "You must enter the name of your dog."
                      }
                    ],
                ...
                <Form.Item label="Height">
                  {getFieldDecorator("height", {
                    rules: [
                      {
                        required: true,
                        message: "Your must enter your dogs height."
                      }
                    ],
